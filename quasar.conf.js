...
module.exports = function(ctx) {
  return {
    ...
    build: {
      ...
      env: ctx.dev
        ? {
            BASE_URL_API: "http://www.halin.net.cn/docs" //dev 开发环境
          }
        : {
    ...
    pwa: {
      ...
      manifest: {
        name: `hlframework frontend web docs`,
        short_name: `hlframework frontend web docs`,
        description: `hlframework frontend web docs`,
        display: "standalone",
    ...
    electron: {
      ...
      builder: {
        ...
        appId: "hlframework_frontend_web_docs"
